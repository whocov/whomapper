  ...
  geoms_out <- append(
    ...
    list(
      ...
      geom_sf(data = disp_area[grepl("Lake", disp_area$name),],
              col = who_map_col("lakes"), fill = background_col, linewidth = 0.2)
